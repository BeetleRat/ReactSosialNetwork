...
public class UserModel {
    ...
    @OneToMany(mappedBy = "user1", cascade = CascadeType.PERSIST, fetch = FetchType.LAZY)
    private Set<PrivateChatModel> chatsWhereIAmUser1 = new HashSet();

    @OneToMany(mappedBy = "user2", cascade = CascadeType.PERSIST, fetch = FetchType.LAZY)
    private Set<PrivateChatModel> chatsWhereIAmUser2 = new HashSet();

    public UserModel() {
    }

    public UserModel(int userID, String email, String imgURL, String nickname, String status, String country, String city, boolean lookingForAJob, String searchJobDescription, String facebook, String website, String vk, String twitter, String instagram, String youtube, String github, String mainlink) {
        this.userID = userID;
        this.email = email;
        this.imgURL = imgURL;
    ...
    public Set<UserModel> getFollowedUsers() {
        return followedUsers;
    }

    public Set<UserModel> getUsersWhoFollowedMe() {
        return usersWhoFollowedMe;
    }

    public Set<RefreshTokenModel> getRefreshTokens() {
    ...
    public Set<PrivateChatModel> getChatsWhereIAmUser1() {
        return chatsWhereIAmUser1;
    }

    public Set<PrivateChatModel> getChatsWhereIAmUser2() {
        return chatsWhereIAmUser2;
    }
    ...
    public void setFollowedUsers(Set<UserModel> followedUsers) {
        this.followedUsers = followedUsers;
    }

    public void setUsersWhoFollowedMe(Set<UserModel> usersWhoFollowedMe) {
        this.usersWhoFollowedMe = usersWhoFollowedMe;
    }

    public void setRefreshTokens(Set<RefreshTokenModel> refreshTokens) {
    ...
    public void setChatsWhereIAmUser1(Set<PrivateChatModel> chatsWhereIAmUser1) {
        this.chatsWhereIAmUser1 = chatsWhereIAmUser1;
    }

    public void setChatsWhereIAmUser2(Set<PrivateChatModel> chatsWhereIAmUser2) {
        this.chatsWhereIAmUser2 = chatsWhereIAmUser2;
    }
    ...
    public void addFollowedUsers(UserModel... users) {
    ...
    public void removeFollowedUsers(UserModel... users) {
    ...
    public void addUsersWhoFollowedMe(UserModel... users) {
        for (UserModel user : users) {
    ...
    public void removeUsersWhoFollowedMe(UserModel... users) {
    ...
    public void setAllFromAnotherUser(UserModel copedUser) {
